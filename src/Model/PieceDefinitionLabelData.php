...
class PieceDefinitionLabelData
{
    ...
    {
      return $this->routingBarcode;
    }

    /**
     * @param string $routingBarcode
     * @return \DHLClient\Model\PieceDefinitionLabelData
     */
    public function setRoutingBarcode($routingBarcode)
    {
